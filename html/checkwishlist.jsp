...
<head>
    ...
    <title>Classic Curves-WISHLIST</title>
...
{
  %>
  <h3 style="text-align:center;">Sign In to View WISHLIST!!</h3>
  <%
  } 
else 
{
    out.println("<script>setTimeout(function(){location.href = 'cart.jsp'; }, 10);</script>");
}
 %>
 </div>
</div>
