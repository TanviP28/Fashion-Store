...
double n=Double.parseDouble(request.getParameter("number"));
double sum=0;
try
{
            ...
            <table class="table ">
                ...
                <tbody class="text-center">
                    <tr>
                        ...
                        <td class="border-0 align-middle"><a href="cartremove1.jsp?mess=<%=rs.getString(3)%>" class="text-dark"><i class="fa fa-trash"></i></a></td>
...
<div class="col-lg-6" style="margin-left:370px;margin-top:50px;margin-bottom:50px;width:100%;border:2px solid black;padding:20px;" >
            ...
            <div class="p-4">                
                <ul class="list-unstyled mb-4" style="font-size:19px">
                    ...
                    <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Discount</strong><strong><%=(n*10)%></strong></li>
